...
p_stacked <- ggplot(stance_percentages, aes(x = role, y = percentage, fill = position)) +
  ...
  labs(
    ...
    y = "Percentage",
    fill = "Stance",
    title = "5b. Share of stance by government ministry: large projects"
  ) +
...
ggsave("plot_government_ministries_large_projects.pdf", plot = p_stacked, device = cairo_pdf, width = 10, height = 6)
extrafont::embed_fonts("plot_government_ministries_large_projects.pdf")
