...
# Filter data for the specific affiliations, considerations, and approved projects
...
filtered_data <- subset(query_result, affiliation %in% desired_affiliations & project_status == "approved")
print("Data filtered")
